            ...
            return (
                <div id="flyer">
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{phone.slice(0, 3)}-{phone.slice(3, 6)}-{phone.slice(6)}</td>
                                        </tr>
                                        <tr>
                    ...
                    <div className="row">
                        ...
                        DESCRIPTION: <span className="description">{caseTypeDisplay} on {data.date}. Size: {size}.  Last seen near {location}. {description}</span>
                        </div>
                    </div>
                    <div className="row">
