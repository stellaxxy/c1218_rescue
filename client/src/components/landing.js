    ...
    return(
        <div className="landing">
            ...
            <div className="btn-container">
                <Link to="/lostlanding" className="waves-effect waves-light btn">Lost a Pet</Link>
                <Link to="/foundlanding" className="waves-effect waves-light btn">Found a Pet</Link>
            </div>
        </div>
    );
}